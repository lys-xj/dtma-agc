...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, default='acm')  # 改acm
    parser.add_argument('--k', type=int, default=14)
    parser.add_argument('--lr', type=float, default=1e-3)
    parser.add_argument('--n_clusters', default=3, type=int)  # 改聚类数3
    parser.add_argument('--n_z', default=10, type=int)
    parser.add_argument('--pretrain_path', type=str, default='acm.pkl')
